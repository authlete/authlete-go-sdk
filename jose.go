...
func newJose(rootSDK *Authlete, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Jose {
	return &Jose{
		rootSDK:          rootSDK,
...
func (s *Jose) Verify(ctx context.Context, serviceID string, body *components.JoseVerifyRequest, opts ...operations.Option) (*operations.JoseVerifyAPIResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/{serviceId}/jose/verify", request, nil)
	if err != nil {
	...
	res := &operations.JoseVerifyAPIResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.JoseVerifyResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.JoseVerifyResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
