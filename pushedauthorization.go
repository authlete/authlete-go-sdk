...
func newPushedAuthorization(rootSDK *Authlete, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PushedAuthorization {
...
func (s *PushedAuthorization) Create(ctx context.Context, serviceID string, body components.PushedAuthorizationRequest, opts ...operations.Option) (*operations.PushedAuthReqAPIResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/{serviceId}/pushed_auth_req", request, nil)
	if err != nil {
	...
	res := &operations.PushedAuthReqAPIResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PushedAuthorizationResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PushedAuthorizationResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
