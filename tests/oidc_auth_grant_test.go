...
func TestOIDCAuthGrantFlow(t *testing.T) {
	...
	t.Run("OidcBasicFlow", func(t *testing.T) {
		nonce := randomNonce(t)
		...
		require.NotNil(t, tok.IDToken, "id_token must be issued for an openid request")

		// Step 4: Validate id_token claims.
