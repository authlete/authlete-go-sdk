...
func newTokens(rootSDK *Authlete, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Tokens {
	return &Tokens{
		rootSDK:          rootSDK,
...
func (s *Tokens) Delete(ctx context.Context, serviceID string, clientID string, subject string, opts ...operations.Option) (*operations.ClientAuthorizationDeleteAPIResponse, error) {
