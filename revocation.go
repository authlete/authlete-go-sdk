...
func newRevocation(rootSDK *Authlete, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Revocation {
	return &Revocation{
		rootSDK:          rootSDK,
...
func (s *Revocation) Process(ctx context.Context, serviceID string, body components.RevocationRequest, opts ...operations.Option) (*operations.AuthRevocationAPIResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/{serviceId}/auth/revocation", request, nil)
	if err != nil {
	...
	res := &operations.AuthRevocationAPIResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.RevocationResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.RevocationResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
